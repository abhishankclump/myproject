...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        try:
            ...
            self.url = "mongodb+srv://{}:{}@cluster0.kaevq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(
    ...
    def insertRecord(self, db_name, collection_name, record):
        ...
        try:
            ...
            collection = self.getCollection(collection_name=collection_name, db_name=db_name)
            _id = collection.insert_one(record)
    ...
    def InsertRecordOnQuery(self, db_name, collection_name, query):
        """
        """
        try:
            collection_check_status = self.isCollectionPresent(collection_name=collection_name, db_name=db_name)
    ...
    def store_image_to_db(self,collection_name,db_name,image_name, image_data):
        """
        store image to mongodb data base
        :param image_name:
        :param image_data:
        :return:
        """
    ...
    def get_image_from_db_by_id(self,db_name,collection_name,image_id):
        """
        get image from mongodb data base
        :param image_id:
        :return:
        """
        collection = self.getCollection(collection_name=collection_name, db_name=db_name)
    ...
    def get_by_id(self,db_name,collection_name,id):
        """
        get image from mongodb data base
        :param image_id:
        :return:
